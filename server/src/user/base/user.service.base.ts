...
export class UserServiceBase {
  ...
  async findAnnonce(
    parentId: string,
    args: Prisma.AnnonceFindManyArgs
  ...
  async findInteractionUsers(
    parentId: string,
    args: Prisma.InteractionUserFindManyArgs
  ): Promise<InteractionUser[] | null> {
    return this.prisma.user
      .findUnique({
        where: { id: parentId },
      })
      .interactionUsers(args);
  }

  async findInteractionUsers2(
    parentId: string,
    args: Prisma.InteractionUserFindManyArgs
  ): Promise<InteractionUser[] | null> {
    return this.prisma.user
